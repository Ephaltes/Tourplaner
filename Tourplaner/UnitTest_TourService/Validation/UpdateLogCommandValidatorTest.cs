...
{
    public class UpdateLogCommandValidatorTest
    {
        private UpdateLogCommand query;
        private UpdateLogCommandValidator validator;
        ...
        public void Setup()
        {
            ...
            query = new UpdateLogCommand(entity);
            validator = new UpdateLogCommandValidator();
        }

        [Test]
        public async Task UpdateLogCommandValidation_successful()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_Id()
        {
            query.Entity.Id = 0;
            var result = validator.TestValidate(query);
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_Destination()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_Distance()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_Origin()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_Rating()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_RouteId()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_EndDateSmallerStartDate()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_EndTime()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_StartTime()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_BPMTooHigh()
        {
        ...
        [Test]
        public async Task UpdateLogCommandValidation_fails_BPMTooLow()
        {
            query.Entity.BPM = 0;
            var result = validator.TestValidate(query);
            var error = result.ShouldHaveValidationErrorFor(x => x.Entity.BPM);
